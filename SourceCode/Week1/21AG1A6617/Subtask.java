...
public class Subtask {
    ...
    public void displaySubTask(){
        ...
        System.out.println("Subtask ID: " + subtask.getSubtask_id());
        System.out.println("Subtask Name: " + subtask.getSubtask_name());
        System.out.println("Description: " + subtask.getDescription());
        System.out.println("Task ID: " + subtask.getTask_id());
    }
}
